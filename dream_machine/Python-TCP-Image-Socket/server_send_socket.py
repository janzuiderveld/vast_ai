...
if __name__ == "__main__":
    ...
    parser.add_argument('--ftp_filepath', type=str, default='/Users/janzuiderveld/Documents/GitHub/vast_ai/dream_machine/Sketch-Simulator/out/to_send', help='ftp filepath')
...
if __name__ == "__main__":
    # argparser
    parser = argparse.ArgumentParser(description='TCP client')
    parser.add_argument('--ftp_filepath', type=str, default='Sketch-Simulator/out/to_send', help='ftp filepath')
